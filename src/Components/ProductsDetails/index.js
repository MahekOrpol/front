...
Please let me know the next steps.`;
  ...
  const faqs = [
    {
      icon: <img loading="lazy" src={require("../../Images/watch.png")}   alt="product details"/>,
      title: "Shipping",
      answer:
    ...
    {
      icon: <img loading="lazy" src={require("../../Images/Vector (6).png")}   alt="product details"/>,
      title: "Return Policy",
      answer:
      ...
      <div className={isCartOpen ? "blurred" : ""}>
        ...
        <div className="container detail_arrowW_xss">
          ...
          <div className="heder_sec_main d-flex flex-column align-items-center hdr_csd mt-md-3 szdcd_99909">
            ...
            <img loading="lazy" src={require("../../Images/Groupimg.png")}   alt="product details"/>
          </div>
