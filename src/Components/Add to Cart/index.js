     ...
     <div className="cart-items">
        ...
        <img src={require("../../Images/image 98.png")} />
          <div className="cart_item_detail">
            <h5 className="fw-bold mb-1 main_cdsss">Two Stone Diamond Ring</h5>
            <h6 className="main_cdsss">Diamond Shape: Round</h6>
            <div className="d-flex align-item-center justify-content-between main_cdsss">
              ...
              <div><p className="fw-bold m-0">₹30,000</p></div>
            </div>
            <div className="d-flex align-item-center justify-content-between mt-3">
              <div className="d-inline-flex align-items-center border rounded p-2 bg-light">
              <button
                  className="btn btn-sm bg_prime rounded-circle me-2 fw-bold"
                  onClick={decrement}
                >
                  −
                </button>
                ...
                <button
                  className="btn btn-sm bg_prime rounded-circle ms-2 fw-bold"
                  onClick={increment}
                >
                  +
                </button>
      ...
      <div className="cart-footer main_cdsss">
        ...
        <div><h5 className="fw-bold">Total:</h5></div><div><h5 className="fw-bold"> ₹30,000</h5></div>
        </div>
        <button className="btn btn_check_out w-100 main_cdsss">Secure Checkout</button>
      </div>
    </div>
  );
};
